...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            'fullscreen', 'source', '|', 'undo', 'redo', '|','bold',  'formatmatch','pasteplain', '|', 'selectall', 'preview', 'removeformat', 'date', '|', 'time', 'link', 'unlink', 'simpleupload', 'emotion', '|', 'spechars', 'drafts', 'help', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 
            // 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'autotypeset', 'blockquote', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'cleardoc',
